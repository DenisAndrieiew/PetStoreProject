...
public class CreateWithArray implements Command {
    private static final String APPENDIX = "createWithArray";
    ...
    public boolean execute() {
        ...
        while (true) {
            ...
            if (!utils.getView().read().equals("y")) {break;}
        }
        Utils.post(String.format("%s%s%s", Utils.URL, Utils.USER_SUFFIX, APPENDIX), users.toArray(), utils.getView());
    ...
    public String commandDescription() {
        return "create Users with array";
    }
}
